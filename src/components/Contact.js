...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Use your email with formsubmit.co for contact form handling
      const response = await fetch('https://formsubmit.co/anakala@usc.edu', {
        method: 'POST',
        headers: {
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:anakala@usc.edu" className="hover:text-primary transition-colors">
                  anakala@usc.edu
                </a>
              </div>
              <div className="flex items-center gap-3">
